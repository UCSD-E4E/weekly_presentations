...
\begin{frame}{Label Studio}
    \centering
    \includegraphics[height=0.7\textheight,width=0.7\textwidth,keepaspectratio]{images/a3d_labelstudio.png}
\end{frame}


\begin{frame}{Attenuation Map Optimization}
    \href{https://github.com/UCSD-E4E/label-studio/pkgs/container/label-studio/335825750?tag=20250113.162625-develop-6c02a29}{Released Docker Image}
\end{frame}
