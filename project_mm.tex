...
\begin{frame}{Normalized Satellite Data}
     \centering
     \includegraphics[height=0.7\textheight,width=0.7\textwidth,keepaspectratio]{MM3.png}
\end{frame}

\begin{frame}{Mask Works?}
     \centering
     \includegraphics[height=0.7\textheight,width=0.7\textwidth,keepaspectratio]{MM1.png}
     \includegraphics[height=0.7\textheight,width=0.7\textwidth,keepaspectratio]{MM2.png}
\end{frame}
