...
\begin{frame}{Training Progress}
    ...
    \begin{columns}
        \begin{column}{0.35\textwidth}
            \includegraphics[height=0.8\textheight,width=0.9\textwidth,keepaspectratio]{images/memory.png}
        \end{column}
        \begin{column}{0.35\textwidth}
            \includegraphics[height=0.8\textheight,width=0.9\textwidth,keepaspectratio]{images/progress_train.png}
        \end{column}
        \begin{column}{0.35\textwidth}
            \includegraphics[height=0.8\textheight,width=0.9\textwidth,keepaspectratio]{images/train_gradient.png}
        \end{column}
    \end{columns}
    \begin{itemize}
