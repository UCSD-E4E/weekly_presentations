...
\begin{frame}{Fourier Transform and Spectral Artifacting}
    \begin{columns}
        \begin{column}{0.5\textwidth}
            \includegraphics[height=1\textheight,width=1\textwidth,keepaspectratio]{images/Signal_Amplitude.png}
        \end{column}
        \begin{column}{0.5\textwidth}
            \includegraphics[height=1\textheight,width=1\textwidth,keepaspectratio]{images/Amplitude_vs_Freq.png}
        \end{column}
    \end{columns}
\end{frame}
