...
\begin{frame}{SmartFin}
    \begin{columns}[c] 
        \begin{column}{0.5\textwidth}
            \centering
            \includegraphics[width=0.9\linewidth]{smartfin_picture.jpg}
        \end{column}
        \begin{column}{0.5\textwidth}
...
\begin{frame}{Why Not Buoys?}
    \begin{columns}[c]
        \begin{column}{0.5\textwidth}
            \centering
            \includegraphics[width=0.9\linewidth]{buoy.jpg}
            \vspace{0.5em}
...
\begin{frame}{How Far Along Are We?}
    \begin{center}
        \includegraphics[width=0.7\textwidth]{buoy_vs_smartfin_data.jpg}
        \vspace{1em}
...
\begin{frame}{My Goals for the Summer}
    \begin{columns}[c]
        \begin{column}{0.45\textwidth}
            \centering
            \includegraphics[width=0.85\linewidth]{imu-diagram.png}
        \end{column}
...
\begin{frame}{Plan for the Next Week}
    \begin{columns}[T]
        \begin{column}{0.5\textwidth}
            \centering
            \includegraphics[width=0.9\linewidth]{sst_chart.png}
        \end{column}
        \begin{column}{0.5\textwidth}
            \centering
            \includegraphics[width=0.9\linewidth]{static_test_chart.png}
        \end{column}
    \end{columns}
    \vspace{1em}
    \begin{center}
